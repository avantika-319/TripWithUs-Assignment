...
function getPricingSorted(pricing, hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  hotelsCopy.sort((hotel1, hotel2) =>
    getPricingSorted(pricing, hotel1, hotel2)
  );
  res.json({ hotels: hotelsCopy });
});

function getRatingSorted(rating, hotel1, hotel2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  let hotelsCopy = hotels.slice();
  hotelsCopy.sort((hotel1, hotel2) => getRatingSorted(rating, hotel1, hotel2));
  res.json({ hotels: hotelsCopy });
});

function getReviewSorted(reviews, hotel1, hotel2) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  let hotelsCopy = hotels.slice();
  hotelsCopy.sort((hotel1, hotel2) => getReviewSorted(reviews, hotel1, hotel2));
  res.json({ hotels: hotelsCopy });
});
